...
(function () {
  ...
  if (navEl) {
    var clipNav = function () {
      ...
      // One SVG mask of the silhouette for every engine. (clip-path is unreliable here:
      // WebKit ignores it on backdrop-filtered layers, and Chrome drops it when the blur is removed.)
